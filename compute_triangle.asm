...
segment .data
system_clock_start db "The starting time on the system clock is %d tics", 10, 0
...
good_morning db "Good morning %s %s. We take care of all your triangles", 10, 10, 0
...
thank_you db "Thank you %s. You entered %lf %lf and %lf.", 10, 0
result_third_length db "The length of the third side is %1.6lf", 10, 0

send_to_driver db "This length will be sent to the driver program.", 0
system_clock_end db "The final time on the system clock is %lf tics.", 10, 0
good_day db "Have a good day %s %s", 0
